...
PostgreSQL canon is authoritative. Retrieved memories are supporting recall. If the task conflicts with canon, preserve canon and write around the conflict. Do not reset personality, relationships, emotional progression, injuries, secrets, or world rules.`;
